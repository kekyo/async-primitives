  ...
  describe('process.nextTick hook (Node.js only)', () => {
    it('should maintain logical context across process.nextTick boundary when available', async () => {
      ...
      if (typeof process === 'undefined' || !process.nextTick) {
        console.log(
          'Skipping process.nextTick test - not available in this environment'
        );
        return;
      }
    ...
    it('should handle process.nextTick with arguments', async () => {
      if (typeof process === 'undefined' || !process.nextTick) {
        console.log(
          'Skipping process.nextTick with arguments test - not available in this environment'
        );
        return;
      }
    ...
    it('should handle nested process.nextTick calls', async () => {
      if (typeof process === 'undefined' || !process.nextTick) {
        console.log(
          'Skipping nested process.nextTick test - not available in this environment'
        );
        return;
      }
      ...
      const {
        setLogicalContextValue: freshSetValue,
        getLogicalContextValue: freshGetValue,
        runOnNewLogicalContext: freshRunOnNew,
      } = await import('../src/primitives/logical-context');
  ...
  describe('EventTarget.addEventListener hook', () => {
    it('should maintain logical context across EventTarget event handlers', async () => {
      ...
      if (typeof EventTarget === 'undefined') {
        console.log(
          'Skipping EventTarget test - not available in this environment'
        );
        return;
      }
    ...
    it('should handle EventTarget addEventListener with handleEvent object', async () => {
      if (typeof EventTarget === 'undefined') {
        console.log(
          'Skipping EventTarget handleEvent test - not available in this environment'
        );
        return;
      }
    ...
    it('should handle context isolation across different EventTarget instances', async () => {
      if (typeof EventTarget === 'undefined') {
        console.log(
          'Skipping EventTarget isolation test - not available in this environment'
        );
        return;
      }
    ...
    it('should handle EventTarget addEventListener with null listener', async () => {
      if (typeof EventTarget === 'undefined') {
        console.log(
          'Skipping EventTarget null listener test - not available in this environment'
        );
        return;
      }
    ...
    it('should work with different event types and options', async () => {
      if (typeof EventTarget === 'undefined') {
        console.log(
          'Skipping EventTarget options test - not available in this environment'
        );
        return;
      }
